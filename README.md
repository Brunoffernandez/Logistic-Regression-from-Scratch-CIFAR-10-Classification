...
## Project Overview
This repository contains the mathematical implementation of classic Machine Learning algorithms and their application to a real-world computer vision problem. The project was originally developed as part of an academic assignment on Statistical Learning.

**Contributions (and the focus of this repository) include:**
